...
_COMMIT=559fa6f6c2aab2e1d73b6fde429886275dc37a62
TERMUX_PKG_SRCURL=git+https://github.com/utkarshdalal/wine-9.2-custom.git
TERMUX_PKG_SHA256=SKIP_CHECKSUM
TERMUX_PKG_GIT_BRANCH=main
TERMUX_PKG_DEPENDS="fontconfig, freetype, krb5, gst-plugins-base, gstreamer, libandroid-shmem, libandroid-shmem-static, libandroid-spawn, libandroid-spawn-static, libc++, libgmp, libgnutls, libx11, libxcb, libxcomposite, libxcursor, libxfixes, libxi, libxrandr, libxrender, libxxf86vm, ocl-icd, opencl-headers, opengl, pulseaudio, sdl2 | sdl2-compat, vulkan-loader, xorg-xrandr"
