...
TERMUX_PKG_DEPENDS="fontconfig, freetype, krb5, gst-plugins-base, gstreamer, libandroid-spawn, libc++, libgmp, libgnutls, libx11, libxcb, libxcomposite, libxcursor, libxfixes, libxi, libxrandr, libxrender, libxxf86vm, ocl-icd, opencl-headers, opengl, pulseaudio, sdl2 | sdl2-compat, vulkan-loader, xorg-xrandr"
