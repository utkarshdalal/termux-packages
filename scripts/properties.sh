...
# We need to set these variables because of Docker env vars overriding
# default ones from USER and that can lead to wrong permission. Default on a
# different platform or distro might not be exactly `dialout`. So TERMUX__UNAME__ARCH
# can be used to determine the target architecture.
: "${TERMUX__UNAME__ARCH:=$(uname -m)}"
export TERMUX__UNAME__ARCH

# Set JAVA_HOME based on which Java directory actually exists
if [ -d "/usr/lib/jvm/java-17-openjdk-arm64" ]; then
    : "${TERMUX_JAVA_HOME:=/usr/lib/jvm/java-17-openjdk-arm64}"
elif [ -d "/usr/lib/jvm/java-17-openjdk-aarch64" ]; then
    : "${TERMUX_JAVA_HOME:=/usr/lib/jvm/java-17-openjdk-aarch64}"
elif [ -d "/usr/lib/jvm/java-17-openjdk-amd64" ]; then
    : "${TERMUX_JAVA_HOME:=/usr/lib/jvm/java-17-openjdk-amd64}"
else
    # Fallback to a generic path that might exist
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `app.gamenative`
##
TERMUX_APP__PACKAGE_NAME="app.gamenative"
...
#
# Default value: `/data/data/app.gamenative`
##
...
#
# Default value: `/data/data/app.gamenative/termux`
##
...
#
# Default value: `/data/data/app.gamenative/termux/core`
##
...
#
# Default value: `/data/data/app.gamenative/termux/app`
##
...
#
# Default value: `/data/data/app.gamenative/termux/app/i`
##
...
# `TERMUX__APPS_DIR`.
#
# Default value: `/data/data/app.gamenative/termux/app/u`
##
...
#
# Default value: `/data/data/app.gamenative/files`
##
...
#
# Default value: `/data/data/app.gamenative/files/home`
##
...
#
# Default value: `/data/data/app.gamenative/files/home/.termux`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/bin`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/etc`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/include`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/include32`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/include` (`$TERMUX__PREFIX__BASE_INCLUDE_DIR`)
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/lib`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/lib32`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/lib` (`$TERMUX__PREFIX__BASE_LIB_DIR`)
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/libexec`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/opt`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/share`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/var`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/tmp`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/etc/profile.d`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/etc/termux`
##
...
#
# Default value: `/data/data/app.gamenative/cache`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/etc/termux/termux-bootstrap`
##
...
#
# Default value: `/data/data/app.gamenative/files/usr/etc/termux/termux-bootstrap/second-stage`
##
...
# Default value: `app.gamenative`
##
TERMUX_APP__NAMESPACE="app.gamenative"
...
#
# Default value: `/data/data/app.gamenative/termux/app/i/termux`
##
...
#
# Default value: `app.gamenative.app.TermuxActivity`
##
...
#
# Default value: `app.gamenative.app.TermuxService`
##
...
#
# Default value: `app.gamenative.app.RunCommandService`
##
...
#
# Default value: `app.gamenative.app.TermuxOpenReceiver`
##
...
#
# Default value: `/data/data/app.gamenative/termux/app/i/termux/termux-apps-info.env`
##
...
#
# Default value: `/data/data/app.gamenative/termux/app/i/termux/termux-apps-info.json`
##
...
#
# Default value: `/data/data/app.gamenative/termux/app/i/termux/termux-am`
##
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `app.gamenative.api`
##
TERMUX_API_APP__PACKAGE_NAME="app.gamenative.api"
...
# Default value: `app.gamenative.api`
##
TERMUX_API_APP__NAMESPACE="app.gamenative.api"
...
#
# Default value: `/data/data/app.gamenative/termux/app/i/termuxapi`
##
...
#
# Default value: `app.gamenative.api.TermuxApiReceiver`
##
...
#
# Constant value: `app.gamenative.termuxam`
##
TERMUX_AM_APP__NAMESPACE="app.gamenative.termuxam"
...
#
# Default value: `app.gamenative.termuxam.Am`
##
...
TERMUX_REPO_APP__PACKAGE_NAME="app.gamenative"
TERMUX_REPO_APP__DATA_DIR="/data/data/app.gamenative"
TERMUX_REPO__CORE_DIR="/data/data/app.gamenative/termux/core"
TERMUX_REPO__APPS_DIR="/data/data/app.gamenative/termux/app"
TERMUX_REPO__ROOTFS="/data/data/app.gamenative/files"
TERMUX_REPO__HOME="/data/data/app.gamenative/files/home"
TERMUX_REPO__PREFIX="/data/data/app.gamenative/files/usr"
